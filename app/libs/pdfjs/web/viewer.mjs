...
class NewAltTextManager {
  ...
  #save() {
    ...
    this.#telemetryData = {
      ...
      alt_text_altered: this.#guessedAltText && this.#guessedAltText !== altText
    };
    this.#finish();
  }
  destroy() {
...
const PDFViewerApplication = {
  ...
  async _initializeViewerComponents() {
    ...
    if (AppOptions.get("enableUpdatedAddImage")) {
      altTextManager = appConfig.newAltTextDialog ? new NewAltTextManager(appConfig.newAltTextDialog, this.overlayManager) : null;
    } else {
...
const pdfjsVersion = "4.5.1";
const pdfjsBuild = "e6bb1f324";
const AppConstants = {
